                ...
                <div class="card-body">
                    {!! Form::open(['action' => ['HouseServices@update', $service->id], 'method' => 'POST']) !!}
                        <div class="form-group">
                            ...
                            {{ Form::text('service_name',$service->service_name,['class' => 'form-control', 'placeholder' => 'Water', 'id' => 'service']) }}
                        </div>
                        </div>
                        <div class="form-group">
                            ...
                            {{Form::number('service_money',$service->service_money,['class' => 'form-control', 'placeholder' => '5000', 'id' => 'serviceMoney'])}}
                        </div>
                        </div>
