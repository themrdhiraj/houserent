                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            {{ Form::text('people_name','',['class' => 'form-control', 'placeholder' => 'Joe', 'id' => 'people_name']) }}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            {{ Form::tel('people_contact','',['class' => 'form-control', 'placeholder' => '98XXXXXXXX', 'id' => 'people_contact', 'pattern' => '[0-9]{10}']) }}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            {{ Form::tel('people_contact_other','',['class' => 'form-control', 'placeholder' => '98XXXXXXXX', 'id' => 'people_contact_other', 'pattern' => '[0-9]{10}']) }}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            {{ Form::text('people_home_address','',['class' => 'form-control', 'placeholder' => 'Ramechhap', 'id' => 'people_home_address']) }}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            {{Form::number('people_total','',['class' => 'form-control', 'placeholder' => '5', 'id' => 'people_total'])}}
                        </div>
                    </div>
